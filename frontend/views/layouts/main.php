        ...
        <header class="page-header">
            <div class="main-container page-header__container">
                <div class="page-header__logo">
                    <a href="<?= Url::home() ?>">
                        <svg class="page-header__logo-image" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1634 646.35">
                            <g>
                                <g>
                ...
                <div class="header__account">
                    <a class="header__account-photo">
                        <img src="<?= Url::to('@web/img/user-photo.png') ?>" width="43" height="44" alt="Аватар пользователя">
                    </a>
